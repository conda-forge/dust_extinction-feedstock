...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dust_extinction-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `dust_extinction` can be installed with:

```
conda install dust_extinction
```

It is possible to list all of the versions of `dust_extinction` available on your platform with:
